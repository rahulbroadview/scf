class AdminFileListModel {
  String? status;
  int? statuscode;
  List<AdminFileList>? response;

  AdminFileListModel({this.status, this.statuscode, this.response});

  AdminFileListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    statuscode = json['statuscode'];
    if (json['response'] != null) {
      response = <AdminFileList>[];
      json['response'].forEach((v) {
        response!.add(AdminFileList.fromJson(v));
      });
    }
  }
...
class AdminFileList {
  ...
  AdminFileList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    ...
    sanctionAmount = json['sanction_amount'].toString();
