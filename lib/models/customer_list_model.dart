class CustomerListModel {
  String? status;
  int? statuscode;
  List<CustomerListing>? response;

  CustomerListModel({this.status, this.statuscode, this.response});

  CustomerListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    statuscode = json['statuscode'];
    if (json['response'] != null) {
      response = <CustomerListing>[];
      json['response'].forEach((v) {
        response!.add(CustomerListing.fromJson(v));
      });
    }
  }
...
class CustomerListing {
  ...
  CustomerListing.fromJson(Map<String, dynamic> json) {
    id = json['id'];
